...
const BeautifyCommand_1 = require("./commands/BeautifyCommand");
const SupportCommand_1 = require("./commands/SupportCommand");
program
    .version()
    .command({
    builder: {
    ...
    handler: argv => {
        const main = new BeautifyCommand_1.BeautifyCommand();
        main.beautify(argv).catch((error) => { });
    },
})
    .command({
    aliases: ["list", "ls"],
    ...
    handler: argv => {
        const main = new SupportCommand_1.SupportCommand();
        main.support(argv).catch((error) => { });
    },
})
    .help().argv;
